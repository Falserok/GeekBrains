public class Main {
    ...
    public void runOneThread() {
        ...
        calculate(arr);
        System.out.println("Однопоточный метод заканчивается на: " + (System.currentTimeMillis() - a));
    }
    ...
    public void runTwoThreads() {
        ...
        System.out.println("Двупоточный метод заканчивается на: " + (System.currentTimeMillis() - a));
    }
